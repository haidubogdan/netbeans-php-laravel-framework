 ...
 * @author bhaidu
 */
public final class PtyRerunAction extends AbstractAction implements ChangeListener {
    ...
    public PtyRerunAction() {
        ...
        putValue(Action.SHORT_DESCRIPTION, NbBundle.getMessage(PtyRerunAction.class, "Rerun"));
    }
