 ...
 */
public final class TerminalExecutable1 {

    private static final Logger LOGGER = Logger.getLogger(TerminalExecutable1.class.getName());
     ...
     */
    public TerminalExecutable1(String command) {
     ...
     */
    public TerminalExecutable1 executableName(@NonNull String executableName) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 displayName(String displayName) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 optionsSubcategory(String optionsSubcategory) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 viaPhpInterpreter(boolean viaPhpInterpreter) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 viaAutodetection(boolean viaAutodetection) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 redirectErrorStream(boolean redirectErrorStream) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 workDir(@NonNull File workDir) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 warnUser(boolean warnUser) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 additionalParameters(@NonNull List<String> additionalParameters) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 environmentVariables(Map<String, String> environmentVariables) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable1 validationHandler(@NonNull PhpExecutableValidator.ValidationHandler validationHandler) {
     ...
     * @since 0.17
     */
    public TerminalExecutable1 fileOutput(@NonNull File fileOutput, @NonNull String outputCharset, boolean fileOutputOnly) {
     ...
     * @since 0.3
     */
    public TerminalExecutable1 noInfo(boolean noInfo) {
        this.noInfo = noInfo;
        return this;
    }
     ...
     * @since 0.19
     */
    public TerminalExecutable1 noDebugConfig(boolean noDebugConfig) {
     ...
     * {@link TerminalExecutable#run(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2) run(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2)} instead.
     * @return task representing the actual run, value representing result of the {@link Future} is exit code of the process
     * or {@code null} if the executable cannot be run
     * @see #run()
     * @see #run(ExecutionDescriptor)
     ...
     * <p>
     * <b>WARNING:</b> If any {@link ExecutionDescriptor.InputProcessorFactory2 output processor factory} should be used, use
     * {@link TerminalExecutable#runAndWait(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2, String) run(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2, String)} instead.
     * @param executionDescriptor execution descriptor to be used
     * @param progressMessage message displayed if the task is running in the UI thread
     * @return exit code of the process or {@code null} if any error occured
     * @throws ExecutionException if any error occurs
     ...
     * @since 0.28
     */
    @NbBundle.Messages("TerminalExecutable.debug.progress2=Debugging...")
    @CheckForNull
    public Integer debug(@NonNull final FileObject startFile, @NonNull final ExecutionDescriptor executionDescriptor,
        ...
        }, Bundle.TerminalExecutable_debug_progress());
        if (executionException.get() != null) {
            throw executionException.get();
        }
    ...
    Integer debugInternal(@NonNull FileObject startFile, @NonNull ExecutionDescriptor executionDescriptor,
        ...
        Callable<Cancellable> task = new Callable<Cancellable>() {
            ...
            public Cancellable call() throws Exception {
                try {
                    result.set(TerminalExecutable1.this.runInternal(notControllableExecutionDescriptor, outProcessorFactory, true));
                } finally {
    ...
    @NbBundle.Messages("TerminalExecutable.debug.noMoreSessions2=Debugger session is already running. Restart?")
    private static boolean warnNoMoreDebugSession() {
        NotifyDescriptor descriptor = new NotifyDescriptor.Confirmation(Bundle.TerminalExecutable_debug_noMoreSessions(), NotifyDescriptor.OK_CANCEL_OPTION);
    ...
    static final class InfoInputProcessor implements InputProcessor {
        ...
        @NbBundle.Messages("InfoInputProcessor.done2=Done.")
        @Override
    ...
    static final class InfoOutputProcessorFactory implements ExecutionDescriptor.InputProcessorFactory2 {
        @Override
        public InputProcessor newInputProcessor(InputProcessor defaultProcessor) {
