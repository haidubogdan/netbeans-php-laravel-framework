 ...
 * @author bogdan
 */
public class CustomProcessBuilder implements Callable<Process> {

    private final CustomProcessInfo info;
    private ExternalTerminal externalTerminal = null;

    private CustomProcessBuilder(final ExecutionEnvironment execEnv) {
        info = new CustomProcessInfo(execEnv);
    }
     ...
     */
    public static CustomProcessBuilder newProcessBuilder(ExecutionEnvironment execEnv) {
        return new CustomProcessBuilder(execEnv);
    }
     ...
     * @return new instance of process builder
     */
    public static CustomProcessBuilder newLocalProcessBuilder() {
        return new CustomProcessBuilder(ExecutionEnvironmentFactory.getLocal());
    }

    public CustomProcessBuilder redirectError() {
     ...
     * @return
     */
    public CustomProcessBuilder setExecutable(String executable) {
    ...
    public CustomProcessBuilder setCommandLine(String commandLine) {
     ...
     * @return this
     */
    public CustomProcessBuilder addNativeProcessListener(ChangeListener listener) {
        info.addChangeListener(listener);
        return this;
    }

    public CustomProcessBuilder removeNativeProcessListener(ChangeListener listener) {
    ...
    public NativeProcess call() throws IOException {
        AbstractCustomProcess process = null;
        ...
        if (externalTerminal == null && NbStartUtility.getInstance().isSupported(info.getExecutionEnvironment())) {
            process = new CustomRemoteProcess(info);
        } else {
            throw new IllegalStateException("No process created"); // NOI18N
        }
     ...
     * @return this
     */
    public CustomProcessBuilder setWorkingDirectory(String workingDirectory) {
     ...
     * @return this
     */
    public CustomProcessBuilder setArguments(String... arguments) {
     ...
     */
    public CustomProcessBuilder useExternalTerminal(/*@NullAllowed*/ExternalTerminal terminal) {
     ...
     * @return this
     */
    public CustomProcessBuilder unbufferOutput(boolean unbuffer) {
     ...
     * @return this
     */
    public CustomProcessBuilder setX11Forwarding(boolean x11forwarding) {
     ...
     * @return this
     */
    public CustomProcessBuilder setInitialSuspend(boolean suspend) {
        info.setInitialSuspend(suspend);
        return this;
    }

    private static String loc(String key, String... params) {
        return NbBundle.getMessage(CustomProcessBuilder.class, key, params);
    }
     ...
     * @return this
     */
    public CustomProcessBuilder setUsePty(boolean usePty) {
     ...
     * @return this
     */
    public CustomProcessBuilder setMacroExpansion(boolean expandMacros) {
        info.setExpandMacros(expandMacros);
        return this;
    }

    public CustomProcessBuilder setCharset(Charset charset) {
        info.setCharset(charset);
        return this;
    }

    public CustomProcessBuilder setStatusEx(boolean b) {
        info.setStatusEx(b);
        return this;
    }
}
