 ...
 * @author Andrew
 */
public abstract class CustomProcess extends AbstractCustomProcess {

    private final String nbStartPath;
    private volatile ProcessStatusEx statusEx;

    public CustomProcess(final CustomProcessInfo info) {
        super(new CustomProcessInfo(info, true));
