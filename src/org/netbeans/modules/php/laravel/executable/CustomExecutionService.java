...
public class CustomExecutionService {
    ...
    private final CustomExecutionDescriptor descriptor;
    ...
    private CustomExecutionService(CustomProcessBuilder processBuilder, String displayName, CustomExecutionDescriptor descriptor) {
        this.processBuilder = processBuilder;
        this.displayName = displayName;
        this.descriptor = descriptor;
    }

    public static CustomExecutionService newService(CustomProcessBuilder processBuilder,
            CustomExecutionDescriptor descriptor, String displayName) {
        return new CustomExecutionService(processBuilder, displayName, descriptor);
    }
