 ...
 */
public final class TerminalExecutable {

    private static final Logger LOGGER = Logger.getLogger(TerminalExecutable.class.getName());
     ...
     */
    public TerminalExecutable(String command) {
     ...
     */
    public TerminalExecutable executableName(@NonNull String executableName) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable displayName(String displayName) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable optionsSubcategory(String optionsSubcategory) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable viaPhpInterpreter(boolean viaPhpInterpreter) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable viaAutodetection(boolean viaAutodetection) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable redirectErrorStream(boolean redirectErrorStream) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable workDir(@NonNull File workDir) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable warnUser(boolean warnUser) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable additionalParameters(@NonNull List<String> additionalParameters) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable environmentVariables(Map<String, String> environmentVariables) {
     ...
     * @return the PHP Executable instance itself
     */
    public TerminalExecutable validationHandler(@NonNull PhpExecutableValidator.ValidationHandler validationHandler) {
     ...
     * @since 0.17
     */
    public TerminalExecutable fileOutput(@NonNull File fileOutput, @NonNull String outputCharset, boolean fileOutputOnly) {
     ...
     * @since 0.3
     */
    public TerminalExecutable noInfo(boolean noInfo) {
        this.noInfo = noInfo;
        return this;
    }
     ...
     * @since 0.19
     */
    public TerminalExecutable noDebugConfig(boolean noDebugConfig) {
     ...
     * @since 0.28
     */
    @NbBundle.Messages("TerminalExecutable.debug.progress=Debugging...")
    @CheckForNull
    ...
    Integer debugInternal(@NonNull FileObject startFile, @NonNull ExecutionDescriptor executionDescriptor,
        ...
        Callable<Cancellable> task = new Callable<Cancellable>() {
            ...
            public Cancellable call() throws Exception {
                try {
                    result.set(TerminalExecutable.this.runInternal(notControllableExecutionDescriptor, outProcessorFactory, true));
                } finally {
...
//        }
    ...
    @NbBundle.Messages("TerminalExecutable.debug.noMoreSessions=Debugger session is already running. Restart?")
