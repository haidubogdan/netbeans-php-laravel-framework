 ...
 */
// @NotThreadSafe
public final class CustomProcessInfo {
    ...
    public CustomProcessInfo(ExecutionEnvironment execEnv) {
    ...
    CustomProcessInfo(CustomProcessInfo info, boolean copyListeners) {
    ...
    public static String getCharset(NativeProcess process) {
        String res = null;
        if (process instanceof AbstractCustomProcess) {
            res = ((AbstractCustomProcess) process).getCharset();
        }
