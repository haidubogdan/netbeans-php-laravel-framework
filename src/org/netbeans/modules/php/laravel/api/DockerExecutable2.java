 ...
 * @author bogdan.haidu
 */
public final class DockerExecutable2 {

    private static final Logger LOGGER = Logger.getLogger(DockerExecutable2.class.getName());
     ...
     */
    public DockerExecutable2(String command) {
     ...
     */
    public DockerExecutable2 executableName(@NonNull String executableName) {
     ...
     * @return the DockerExecutable instance itself
     */
    public DockerExecutable2 displayName(String displayName) {
     ...
     * @return the DockerExecutable instance itself
     */
    public DockerExecutable2 optionsSubcategory(String optionsSubcategory) {
     ...
     * @return the DockerExecutable instance itself
     */
    public DockerExecutable2 redirectErrorStream(boolean redirectErrorStream) {
     ...
     * @return the DockerExecutable instance itself
     */
    public DockerExecutable2 workDir(@NonNull File workDir) {
     ...
     * @return the DockerExecutable instance itself
     */
    public DockerExecutable2 warnUser(boolean warnUser) {
     ...
     * @return the DockerExecutable instance itself
     */
    public DockerExecutable2 additionalParameters(@NonNull List<String> additionalParameters) {
     ...
     * @return the DockerExecutable instance itself
     */
    public DockerExecutable2 environmentVariables(Map<String, String> environmentVariables) {
     ...
     * @since 0.17
     */
    public DockerExecutable2 fileOutput(@NonNull File fileOutput, @NonNull String outputCharset, boolean fileOutputOnly) {
     ...
     * @since 0.3
     */
    public DockerExecutable2 noInfo(boolean noInfo) {
        this.noInfo = noInfo;
        return this;
    }
     ...
     * @since 0.19
     */
    public DockerExecutable2 noDebugConfig(boolean noDebugConfig) {
     ...
     * should be used, use
     * {@link DockerExecutable2#run(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2) run(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2)}
     * instead.
     *
     * @return task representing the actual run, value representing result of
     * the {@link Future} is exit code of the process or {@code null} if the
     ...
     * {@link ExecutionDescriptor.InputProcessorFactory2 output processor factory}
     * should be used, use
     * {@link DockerExecutable2#runAndWait(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2, String) run(ExecutionDescriptor, ExecutionDescriptor.InputProcessorFactory2, String)}
     * instead.
     *
     * @param executionDescriptor execution descriptor to be used
     * @param progressMessage message displayed if the task is running in the UI
